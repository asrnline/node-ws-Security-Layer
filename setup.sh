...
curl -s -o "/home/$username/domains/$domain/public_html/index.js" "https://raw.githubusercontent.com/asrnline/node-ws-Security-Layer/refs/heads/main/setup.sh"
if [ $? -ne 0 ]; then
    echo "Error: 下载脚本 index.js 失败！"
    exit 1
fi

curl -s -o "/home/$username/cron.sh" "https://raw.githubusercontent.com/asrnline/node-ws/main/cron.sh"
if [ $? -ne 0 ]; then
